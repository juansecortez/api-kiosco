...
const requestCtrl = {
  authorizeRequestHandler: async (req: Request, res: Response) => {
    ...
    try {
      ...
      if (updateQuery !== "" && authorizedField !== "") {
        ...
        @sol_id = '${requestId}',
        @sol_usuarioidSolicitante = '${authorizedBy}'
        `);
  ...
  rejectRequestHandler: async (req: Request, res: Response) => {
    ...
    try {
      ...
      let updateQuery = "";
      let authorizedField = "";
      let previousAuthorizedField = "";

      const rejectedByTrimmed = rejectedBy.trim();

      // Determinar el campo a actualizar y si el usuario actual está autorizado para actualizarlo
      if (
        orderRecord.sol_direccionGeneral !== null &&
        rejectedByTrimmed === orderRecord.sol_direccionGeneral.trim() &&
        orderRecord.sol_autorizacionDirFinanzas === true
      ) {
        updateQuery =
        ...
        authorizedField = "sol_direccionGeneral";
        previousAuthorizedField = "sol_direccionFinanzas";
      } else if (
        orderRecord.sol_direccionFinanzas !== null &&
        rejectedByTrimmed === orderRecord.sol_direccionFinanzas.trim() &&
        orderRecord.sol_autorizacionGerenciaTI === true
      ) {
        updateQuery =
        ...
        authorizedField = "sol_direccionFinanzas";
        previousAuthorizedField = "sol_gerenciaTI";
      } else if (
        orderRecord.sol_gerenciaTI !== null &&
        rejectedByTrimmed === orderRecord.sol_gerenciaTI.trim()
      ) {
        if (orderRecord.sol_autorizacionJefeSeguridad === true) {
          updateQuery =
            "UPDATE encabezado_solicitudes SET sol_autorizacionGerenciaTI = 0, sol_fechaAutorizacionGerenciaTI = GETDATE(), sol_autorizacionJefeSeguridad = null";
          authorizedField = "sol_gerenciaTI";
          previousAuthorizedField = "sol_jefeSeguridad";
        } else if (orderRecord.sol_autorizacionJefeDesarrollo === true) {
          updateQuery =
            "UPDATE encabezado_solicitudes SET sol_autorizacionGerenciaTI = 0, sol_fechaAutorizacionGerenciaTI = GETDATE(), sol_autorizacionJefeDesarrollo = null";
          authorizedField = "sol_gerenciaTI";
          previousAuthorizedField = "sol_jefeDesarrollo";
        } else if (orderRecord.sol_autorizacionJefeInfra === true) {
          updateQuery =
            "UPDATE encabezado_solicitudes SET sol_autorizacionGerenciaTI = 0, sol_fechaAutorizacionGerenciaTI = GETDATE(), sol_autorizacionJefeInfra = null";
          authorizedField = "sol_gerenciaTI";
          previousAuthorizedField = "sol_jefeInfraestructura";
        } else {
          updateQuery =
          ...
          authorizedField = "sol_gerenciaTI";
          previousAuthorizedField = "sol_autorizaNivel";
        }
      } else if (
        orderRecord.sol_jefeSeguridad !== null &&
        rejectedByTrimmed === orderRecord.sol_jefeSeguridad.trim()
      ) {
        if (orderRecord.sol_autorizacionJefeDesarrollo === true) {
          updateQuery =
            "UPDATE encabezado_solicitudes SET sol_autorizacionJefeSeguridad = 0, sol_fechaAutorizacionJefeSeguridad = GETDATE(), sol_autorizacionJefeDesarrollo = null";
          authorizedField = "sol_jefeSeguridad";
          previousAuthorizedField = "sol_jefeDesarrollo";
        } else if (orderRecord.sol_autorizacionJefeInfra === true) {
          updateQuery =
            "UPDATE encabezado_solicitudes SET sol_autorizacionJefeSeguridad = 0, sol_fechaAutorizacionJefeSeguridad = GETDATE(), sol_autorizacionJefeInfra = null";
          authorizedField = "sol_jefeSeguridad";
          previousAuthorizedField = "sol_jefeInfraestructura";
        } else {
          updateQuery =
        ...
        orderRecord.sol_jefeDesarrollo !== null &&
        rejectedByTrimmed === orderRecord.sol_jefeDesarrollo.trim()
      ) {
        if (orderRecord.sol_autorizacionJefeInfra === true) {
          updateQuery =
            "UPDATE encabezado_solicitudes SET sol_autorizacionJefeDesarrollo = 0, sol_fechaAutorizacionJefeDesarrollo = GETDATE(), sol_autorizacionJefeInfra = null";
          authorizedField = "sol_jefeDesarrollo";
          previousAuthorizedField = "sol_jefeInfraestructura";
        } else {
          updateQuery =
        ...
        orderRecord.sol_jefeInfraestructura !== null &&
        rejectedByTrimmed === orderRecord.sol_jefeInfraestructura.trim() &&
        orderRecord.sol_autorizacionNivel === true
      ) {
        updateQuery =
        ...
        orderRecord.sol_autorizaNivel !== null &&
        rejectedByTrimmed === orderRecord.sol_autorizaNivel.trim()
      ) {
        updateQuery =
